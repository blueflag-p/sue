      ...
      <div class="container-fluid">
            ...
            <div class="row">
              <div class="card-header d-flex justify-content-between bg-transparent">
                <div class="header-title">
                  <h2 class="card-title">Assign Child Forms</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="card-header d-flex justify-content-between bg-transparent">
              <div class="header-title">
                <h4 class="card-title ml-4 text-primary">Select Child Forms
                </h4>
              </div>
            </div>
          ...
          <div class="row main_checkboxes">
            <div class="col-6">
              <div class="custom-control custom-checkbox custom-control-inline my-2">
                ...
                <label class="custom-control-label font-weight-bold " for="sub_div_1">Significant
                  Incident Record
                </label>
              </div>
            </div>
            <div class="col-6">
              <div class="custom-control custom-checkbox custom-control-inline my-2">
                ...
                <label class="custom-control-label font-weight-bold" for="care">care
                  plan</label>
              </div>
            </div>
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalCenteredScrollableTitle">Significant Incident Record
            </h5>
