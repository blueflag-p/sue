      ...
      <div class="container-fluid">
            ...
            <div class="row">
              <div class="card-header d-flex justify-content-between bg-transparent">
                <div class="header-title">
                  <h2 class="card-title">Child List
                  </h2>
                </div>
              </div>
            </div>
        ...
        <div class="d-flex">
          ...
          <div class="ml-auto p-2">
            <a href="{{ route('child.create') }}" class="btn btn-primary btn-block">
              Add
            </a>
          </div>
        </div>
              ...
              <tr>
                  <td>
                    <div class="avatar-45 mr-2">
                      <img src="{{asset('/storage/child/'.$item->image)}}" class="img-fluid rounded-circle" alt="image">
                    </div>
                  </td>
                  <td>{{ $item->first_name }}</td>
                  <td>{{ $item->last_name }}</td>
                  <td>{{ $item->getAge($item->dob) }}</td>
                  <td>{{ $item->Admission_date }}</td>
                  <td>{{ $item->address }}</td>
                  <td>
                    <div class="p-2">
                      <a href="{{ route('child.edit',['id' => $item->id]) }}" class="btn btn-primary">View/Edit</a>
