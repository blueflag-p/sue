...
<div class="content-page">
            ...
            <div class="container-fluid">
                <form class='company' action="{{ route('professional.company.store') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="card-header d-flex justify-content-between bg-transparent">
                                    <div class="header-title">
                                        <h2 class="card-title">Create Professional Company</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Contact Name" name="contact_name" placeholder="Full Name">
                            </div>
                        </div>
